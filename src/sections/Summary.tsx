export default function Summary() {
  return (
    <section
      id="summary"
      className="min-h-screen flex flex-col-reverse lg:flex-row justify-center items-center gap-8 lg:gap-16 px-6 md:px-16 transition-colors duration-300"
    >
      <div className="fadeup-enter text-left lg:max-w-full lg:w-1/2">
        ...
        <p className="text-sm md:text-lg text-muted-foreground leading-relaxed transition-colors duration-300">
          ...
          <strong className="text-white">Front-End Developer</strong> with over{" "}
          <strong className="text-white">three years of experience</strong>{" "}
          specializing in <strong className="text-white">Angular</strong>. I
          enjoy creating intuitive, accessible, and user-friendly web interfaces
          for a diverse audience. Currently, I am expanding my expertise in{" "}
